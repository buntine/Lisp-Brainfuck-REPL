...
; following the matching [.
(define (bf-close-loop m p i pos)
...
(define (find-loop-end i pos nest)
  (if (>= pos (length i))
    (begin
...
; for the matching [ instruction.
(define (find-loop-start i pos nest)
  (if (< pos 0)
    (begin
